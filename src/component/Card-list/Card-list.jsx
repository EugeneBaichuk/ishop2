...
export const CardList = () => {
    ...
    const [cards, setCards] = useState([
            ...
            id: 4,
            name: "Лунго (Lungo)",
            img: "https://coffeefan.info/wp-content/uploads/2018/08/kofe-lungo.jpg",
            active: false,
            price: 125,
            storeQuantity: 115,
            descr: "эспрессо с увеличенным количеством воды"
            },
            {
            id: 5,
            name: "Латте (latte)",
            ...
            {
            id: 6,
            name: "Глясе (Glace coffee)",
            img: "https://coffeefan.info/wp-content/uploads/2018/08/kofe-glyase.jpg",
            active: false,
            price: 155,
            storeQuantity: 140,
            descr: "охлаждённый кофе с шариком мороженого. Напиток подают в айриш-бокале с соломинкой."
            },
            {
            id: 7,
    ...
    const deleteCard = (id) => (e) => {
        ...
        setCards(prevState => accepted ? prevState.filter(item => (item.id !== id)): prevState);
      }
